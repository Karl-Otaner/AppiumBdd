...
public class CadastroStep {
	...
	public void fazer_o_cadastro_da_nova_conta() throws Throwable {
		formulario.digiteNome(massa.digiteNome() + new Random().nextInt(10000));
	...
	public void clica_no_botao_menu() throws Throwable {
		//O código não funciona sem o thread.sleep
		Thread.sleep(1000);
		home.cliqueMenu();
	}
	...
	public void validar_o_retorno_a_pagina_inicial() throws Throwable {
		assertTrue(formulario.getConfirmaUsuario().contains(massa.digiteNome()));
	}
	...
	public void validar_mensagem_de_usuario_ja_cadastrado() throws Throwable {
		assertTrue(formulario.mensageErro().contains("REGISTER"));
	}
